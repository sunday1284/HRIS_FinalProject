...
.video-wrapper video {
  min-width: 60%;
  transform: translateX(-15%); /* ← 이 값으로 위치 조정! */
}
.carousel-container {
  display: flex;
...
<!-- 			</div> -->
	...
	<img src="${pageContext.request.contextPath}/resources/template/dist/assets/static/images/logo/saok2.jpg"
	     style="width: 100%; height: auto; object-fit: cover; max-height: 90vh;">

		<div class="carousel-container">
            <h2>대덕우리전자</h2>
            <p>대덕우리전자는 혁신을 통해 더 나은 <br>세상을 만듭니다.<br>
               DaedeokElectronics builds a better world through innovation.</p>
          </div>
