...
<header class="mb-3 d-flex justify-content-between align-items-center bg-light p-3">
    <a href="#" class="burger-btn d-block d-xl-none">
        <i class="bi bi-justify fs-3"></i>
    </a>

    <div>
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#messengerModal" style="display: block;">
            <i class="bi bi-chat-dots"></i> 메신저
        </button>
    </div>
</header>
