  ...
  <div class="row">
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        ...
        <div class="card-body d-flex justify-content-center align-items-center" style="height: 280px;">
          <canvas id="myChart1" width="100%" height="300"></canvas>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        ...
        <div class="card-body d-flex justify-content-center align-items-center" style="height: 280px;">
          <canvas id="myChart3" width="100%" height="300"></canvas>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        ...
        <div class="card-body d-flex justify-content-center align-items-center" style="height: 280px;">
          <canvas id="myChart2" width="100%" height="300"></canvas>
        </div>
      </div>
    </div>
  </div>
...
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <div class="alert alert-primary shadow-sm">
        ...
        - 직원 등록 → 시스템 계정 발급 → 권한 기본할당 → 최초 로그인 본인인증
    </div>
