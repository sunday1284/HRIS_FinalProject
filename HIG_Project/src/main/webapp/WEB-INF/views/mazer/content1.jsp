				...
				<div class="card-body px-4 py-4-5">
					<div class="row">
						...
						<div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
							<h6 class="text-muted font-semibold">전체 직원 수</h6>
							<h2 id="empCount"></h2>
						</div>
					</div>
				</div>
			...
			<div class="card">
				<div class="card-body px-4 py-4-5">
					<div class="row">
						...
						<div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
							<h6 class="text-muted font-semibold">올해 입사자</h6>
							<h2 id="hireCount"></h2>
						</div>
					</div>
				</div>
			...
			<div class="card">
				<div class="card-body px-4 py-4-5">
					<div class="row">
						...
						<div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
							<h6 class="text-muted font-semibold">올해 퇴사자</h6>
			...
			<div class="card">
				<div class="card-body px-4 py-4-5">
					<div class="row">
						...
						<div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
							<h6 class="text-muted font-semibold">오늘 휴가인 직원</h6>
				...
				<div class="card">
					...
					<c:if test="${not empty sessionAccount.attendance}">
						<c:forEach items="${sessionAccount.attendance}" var="attendance">
							<span id="startTime" class="time-info">출근 시간: <strong>${attendance.workStartTime}</strong>
							</span>
							<br />
							<span id="endTime" class="time-info">퇴근 시간: <strong>${attendance.workEndTime}</strong>
							</span>
							<br />
							<span id="workTime">일한 시간: <span class="workDuration"
							...
							<div class="card-body">
								<div class="d-flex flex-column align-items-center gap-4">
									...
									<div class="chart-container"
										...
										<a href="${pageContext.request.contextPath }/approval/mydrafts">기안 문서</a>
										</h5>
									...
									<div class="chart-container"
										style="height: 240px; width: 100%; max-width: 420px;">
										<h5 class="text-center mb-2">
										<a href="${pageContext.request.contextPath }/approval/approverDrafts">결재 문서</a>
										</h5>
					...
					<!-- 이번주 내 할 일 카드 (3) -->
						<div class="col-12 col-lg-3">
						    <div class="card" style="height: 595px;" id="scheduleCard">
						        <div class="card-header">
						            <h4 class="card-title"><a href="#">이번주 전사 일정</a></h4>
						        </div>
						        <div class="card-body">
						                    ...
						                    <c:when test="${not empty scheduleList}">
						                        <c:forEach var="schedule" items="${scheduleList}">
						                            <c:if test="${schedule.scheduleVisibility != 'D' || schedule.empId == principal.realUser.employee.empId}">
						                                <!-- 일정의 공개 범위가 'D'라면 작성자만 볼 수 있도록 처리 -->
						                                <div class="todo-item mb-3 p-3 border rounded shadow-sm" style="background-color: #f6f9fc;">
						                                    <!-- 제목 + 이름 -->
						                                    <div class="d-flex justify-content-between align-items-start mb-2">
						                                        <h6 class="mb-0 fw-bold" style="font-size: 1.1rem; color: #1d3557;"> <!-- 딥 블루 -->
						                                            ${schedule.scheduleTitle}
						                                        </h6>
						                                        <span class="text-muted" style="font-size: 0.85rem; color: #6c757d;"> <!-- 연회색 -->
						                                            ${schedule.empName}
						                                        </span>
						                                    </div>
						                                    ...
						                                    <div class="d-flex justify-content-between">
						                                        <p class="mb-0" style="font-size: 0.95rem; color: #343a40;"> <!-- 짙은 회색 -->
						                                            ${schedule.scheduleContext}
						                                        </p>
						                                        <span style="font-size: 0.75rem; color: #adb5bd;"> <!-- 더 연한 회색 -->
