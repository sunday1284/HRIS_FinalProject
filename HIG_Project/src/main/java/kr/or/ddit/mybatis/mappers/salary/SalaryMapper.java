...
public interface SalaryMapper {
	...
	public int togglePayStatusAll(@Param("salaryIdList")List<Long>salaryIdList,
										@Param("payYear") String payYear,
	 ...
	 * @return
	 */
	public int togglePayRequestAll(@Param("salaryIdList") List<SalaryVO> salaryIdList,
						            @Param("payYear") String payYear,
						            @Param("payMonth") String payMonth);
...
//	public List<SalaryVO> getSalaryList(@Param("payYear")int payYear, @Param("payMonth")int payMonth);
	 ...
	 * @return
	 */
	public int updateSalaryPaidBatch(@Param("salaryIdList") List<SalaryVO> salaryIdList);
