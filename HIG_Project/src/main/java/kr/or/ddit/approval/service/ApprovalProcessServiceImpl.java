...
//        	defBoxVO.getDocFile(); //문서함에 등록된 파일 
	...
	/**
	 * 본인이 신청한 연차 날짜 범위면 신청 못하게 막음 -> 충돌 방지 
	 */
	@Override
    public boolean hasLeaveConflict(String empId, String leaveStartDate, String leaveEndDate) {
        ...
        params.put("leaveStartDate", leaveStartDate);
        params.put("leaveEndDate", leaveEndDate);
        
        int conflictCount = mapper.checkLeaveConflict(params);
