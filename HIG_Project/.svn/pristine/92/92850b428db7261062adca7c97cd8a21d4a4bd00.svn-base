	...
	<div class="d-flex justify-content-between align-items-center mb-2">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb mb-0">
				...
				<li class="breadcrumb-item active" aria-current="page">평가 현황판</li>
...
<body class="p-4">
	...
	<div class="btn-link-group">
	  <a href="${pageContext.request.contextPath}/evaluation/evaluationCandidateList" class="btn btn-primary">
	    <i class="bi-person-check"></i> 평가 대상자 등록
	  </a>
	  <a href="${pageContext.request.contextPath}/evaluation/evaluationTypeList" class="btn btn-primary">
	    <i class="bi-person-plus"></i> 평가 기준 설정
	  </a>
	  <a href="${pageContext.request.contextPath}/evaluation/evaluationDetail_Rank" class="btn btn-outline-success">
	    <i class="bi bi-check-circle-fill text-success"></i> 평가하기
	  </a>
	</div>
