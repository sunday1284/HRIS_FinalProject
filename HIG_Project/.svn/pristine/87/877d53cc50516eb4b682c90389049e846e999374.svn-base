...
public class AnnualReadController {
	...
	public String annualList(Model model,
		...
		model.addAttribute("annualList",service.annualList(teamId));
		model.addAttribute("historyList",AHservice.TotalHisrotyList(teamId));
		model.addAttribute("departmentList",Aservice.departmentList(teamId));
		model.addAttribute("teamList",Aservice.teamList(teamId));
	...
	public String MyAnnual(Model model 
		...
		model.addAttribute("annualCount",service.annaulCount(empId));
